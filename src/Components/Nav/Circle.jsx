...
const Circle = () => {
  ...
  return (
    <motion.div
      ...
      className="h-14 md:h-16 xl:h-[70px] 2xl:h-20 3xl:h-28 w-14 md:w-16 xl:w-[70px] 2xl:w-20 3xl:w-28 fixed z-[999] bg-[#FAFAFA] rounded-full cursor-pointer select-none shadow shadow-black"
    >
      <motion.div
        initial={{
